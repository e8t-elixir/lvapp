defmodule LiveAppWeb.UserAuth do
  import Plug.Conn
  ...
  def log_out_user(conn) do
    ...
    user_token && PGA.delete_session_token(user_token)

    if live_socket_id = get_session(conn, :live_socket_id) do
      LiveAppWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def fetch_current_user(conn, _opts) do
    ...
    user = user_token && PGA.get_user_by_session_token(user_token)
