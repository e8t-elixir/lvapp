defmodule LiveAppWeb.UserSettingsControllerTest do
  ...
  describe "PUT /users/settings/update_email" do
    ...
    test "updates the user email", %{conn: conn, user: user} do
      ...
      assert PGA.get_user_by_email(user.email)
    end
  ...
  describe "GET /users/settings/confirm_email/:token" do
    ...
    test "updates the user email once", %{conn: conn, user: user, token: token, email: email} do
      ...
      refute PGA.get_user_by_email(user.email)
      assert PGA.get_user_by_email(email)
