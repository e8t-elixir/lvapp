defmodule LiveAppWeb.BookControllerTest do
  use LiveAppWeb.ConnCase

  alias LiveApp.Garden

  @create_attrs %{info: "some info", isbn: "some isbn", title: "some title", view_count: 42}
  ...
  def fixture(:book) do
    {:ok, book} = Garden.create_book(@create_attrs)
    book
  end
